...
function fn(){
    let a =10;
    console.log("Line Number 40->a",a);
    a++;

    if(true){
       // console.log("Line Number 44 ->a->",a);  // error  ReferenceError: Cannot access 'a' before initialization
        let a =30;
        console.log("Line Number 46->a->",a);
}
console.log("Line Number 48->a->",a);
}
fn();